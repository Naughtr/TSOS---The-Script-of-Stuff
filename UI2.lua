...
return function(plr, CFG)
    ...
    -- MainFrame height adjusted from 115 to 118 to accommodate the slightly taller scroll container
    ...
    local function unTrn(t)
        ...
        tw(main, tSmth, {Size=ud2(0,120,0,22), Position=ud2(cx.Scale, cx.Offset-60, main.Position.Y.Scale, main.Position.Y.Offset)}, true); fdMnu(0, true); shwUi(true, 120, 118); setA(0)
    end
    ...
    local function plyAnim() 
        local s=mk("TextLabel", gui, {Size=ud2(1,0,1,0), BackgroundTransparency=1, Text="TSOS", TextColor3=c3(255,255,255), Font=Enum.Font.GothamBold, TextSize=100, ZIndex=100}); 
        task.wait(4); 
        tw(s, tFast, {TextTransparency=1}, true); 
        s:Destroy(); 
        main.Visible, main.Size, main.Position = true, ud2(0,0,0,22), ud2(0.5,0,0.5,-59); 
        tw(main, tSmth, {Size=ud2(0,120,0,22), Position=ud2(0.5,-60,0.5,-59)}, true); 
        fdMnu(0, true); 
        -- Height changed to 118 here
        shwUi(true, 120, 118); 
        tgBtns(0, 0.05); 
        setA(0) 
    end
